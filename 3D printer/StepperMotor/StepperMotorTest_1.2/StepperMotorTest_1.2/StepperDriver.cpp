...
void StepperDriver::MoveStep(){
	switch (UsedPins){
		case 1:Driver1MoveON;my_delay_ms(StepInterval);Driver1MoveOFF;break;
		case 2:Driver2MoveON;my_delay_ms(StepInterval);Driver2MoveOFF;break;
		case 3:Driver3MoveON;my_delay_ms(StepInterval);Driver3MoveOFF;break;
		case 4:Driver4MoveON;my_delay_ms(StepInterval);Driver4MoveOFF;break;
		default:break;
		}
...
/**
  ...
  */
void StepperDriver::SetSpeed(const int WantedSpeed){
