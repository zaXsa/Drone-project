...
extern byte computerByte;										//used to store data coming from the computer
extern byte USB_Byte;											//used to store data coming from the USB stick
extern int LED;													//the LED is connected to digital pin 13
extern int timeOut; 											//TimeOut is 2 seconds. This is the amount of time you wish to wait for a response from the CH376S module.
extern String wrData;											//We will write this data to a newly created file.
extern String wrData2;											//We will append this data to an already existing file.

extern SoftwareSerial USB;										// Digital pin 10 on Arduino (RX) connects to TXD on the CH376S module
